  ...
  (
    ...
    return (
      ...
      >
        <div
          className={cn(
            "min-h-10 rounded-md border border-gray-400 text-base md:text-sm ring-offset-background focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-0",
            {
